...
export default function ContatoForm({ home }: ContactProps) {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmitSend)}>
            ...
            <button className="my-3 flex place-items-center gap-2 md:gap-4 bg-cyan-800 transition-all rounded-lg text-white text-xs md:text-base lg:text-2xl  py-2 px-8 md:px-6 lg:py-2 xl:py-4 lg:px-12  font-normal ">
