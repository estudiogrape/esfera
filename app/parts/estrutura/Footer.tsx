...
export default function Rodape() {
  return (
    <footer className="bg-cyan-800 py-10 relative ">
        ...
        <div className="grid grid-cols-1  lg:gap-y-4  place-items-center">
          ...
          <div className="my-3">
            <p className=" text-center text-xs font-semibold ">
              Copyright © 2025{" "}
                ...
                - Esfera <br /> Todos os direitos reservados.
          ...
          <div className="my-3 col-span-1">
            <Link href={ContentLinks.whatsapp}>
              <button className="bg-cyan-400 flex flex-row gap-2  place-items-center rounded-md  py-2 px-8 md:py-2 md:px-12   text-white text-base md:text-lg uppercase font-light">
                <FontAwesomeIcon
                  icon={faHeadphones}
